...
class SectionInfo(FeatureType):
    ...
    def process_raw_features(self, raw_obj):
        ...
        return np.hstack([len(sections)]).astype(np.float32)  # Anders was here:
...
class GeneralFileInfo(FeatureType):
    ...
    def process_raw_features(self, raw_obj):
        ...
        return np.asarray([raw_obj['size'], raw_obj['exports'], raw_obj['imports']], dtype=np.float32)  # Anders was here
...
class HeaderFileInfo(FeatureType):
    ...
    def process_raw_features(self, raw_obj):
        ...
        return np.hstack([raw_obj['optional']['sizeof_code']]).astype(np.float32)  # Anders was here
...
class StringExtractor(FeatureType):
    ...
    def process_raw_features(self, raw_obj):
        ...
        return np.hstack([raw_obj['numstrings'], raw_obj['printabledist'], raw_obj['entropy']]).astype(np.float32)  # Anders was here
...
#                    'ImportsInfo': ImportsInfo(),
    ...
    def raw_features(self, bytez):
        ...
        lief_errors = ()
        try:
            print("Parsing binary with the help of LIEF ...")
...
#            print("\t... processing raw features of type", fe.name)
